...
// UnmarshalEvent unmarshals a slack event based on "type" for both Events API and RTM
func UnmarshalEvent(jsonEvent []byte) (interface{}, error) {
	return eventMapping.Unmarshal(jsonEvent)
}

// Unmarshal will unmarshal an event type
func (e *EventUnmarshaller) Unmarshal(jsonEvent []byte) (interface{}, error) {
	eventHeader := &Event{}
