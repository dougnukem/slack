...
func TestEventCallback(t *testing.T) {
	ev, err := eventMapping.Unmarshal(json.RawMessage(eventCallback))
...
func TestEventURLVerification(t *testing.T) {
	ev, err := eventMapping.Unmarshal(json.RawMessage(urlVerification))
	assert.NoError(t, err)
...
func TestEventMessageChannels(t *testing.T) {
	ev, err := eventMapping.Unmarshal(json.RawMessage(messageChannelsEventCallback))
	assert.NoError(t, err)
	require.IsType(t, &EventCallback{}, ev)
